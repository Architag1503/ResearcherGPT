...
const getExportPipelineScript = (format: string): string => {
  ...
  s.push('                    if (');
  s.push('                      table.closest(\'figure\') ||');
  s.push('                      table.closest(\'.custom-replaced-table\') ||');
  s.push('                      table.parentNode?.querySelector(\'figcaption\') ||');
  s.push('                      table.parentNode?.querySelector(\'.table-caption\') ||');
  s.push('                      table.previousElementSibling?.classList?.contains("table-caption")');
  s.push('                    ) {');
  s.push('                      return;');
  s.push('                    }');
  ...
  s.push('                    if (');
  s.push('                      fig.closest(\'figure\') ||');
  s.push('                      fig.closest(\'.custom-replaced-visual\') ||');
